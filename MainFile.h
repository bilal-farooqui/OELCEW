...
void send_email() {
    ...
    if (emailCurl) {
        const char *from = "hk7800608@gmail.com";
        const char *to = "hk7800608@gmail.com";
        ...
        curl_easy_setopt(emailCurl, CURLOPT_USERNAME, "hk7800608@gmail.com");
        curl_easy_setopt(emailCurl, CURLOPT_PASSWORD, "xyjg wjmg xclb lxlf");
